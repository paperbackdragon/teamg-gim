...
public class Command {
	...
	public static enum COMMANDS {
		PING, PONG, SERVER, AUTH, QUIT, OKAY, SERVERSTATUS, KILL, BROADCAST, SET, GET, FRIENDLIST, ROOM, MESSAGE, FREINDREQUEST, FRIEND, LOGOUT, UPDATE, INFO, ERROR, DOESNOTEXIST
	}
