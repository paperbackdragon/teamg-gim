...
public class User {
	...
	private ConcurrentHashMap<String, User> friendList = Data.getInstance().users; // new
	// HashMap<String,
	// User>();
	private ConcurrentHashMap<String, User> inFreindList = Data.getInstance().users; // new
	// HashMap<String,
	// User>();
	 ...
	 */
	public synchronized String getDisplayPic() {
