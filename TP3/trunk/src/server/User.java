...
public class User {
	...
	private HashMap<String, User> friendList = Data.getInstance().users; // new HashMap<String, User>();
	private HashMap<String, User> inFreindList = Data.getInstance().users; // new HashMap<String, User>();
	private HashMap<String, User> friendRequests = new HashMap<String, User>();
