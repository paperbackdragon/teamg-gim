...
One of the server's most critical responsibilities is notifying users of changes to the users; this is done using the concept of subscriptions.  A user (the subscriber) is considered to be subscribed to another user (the subscribee) if they meet at least one of two conditions:
